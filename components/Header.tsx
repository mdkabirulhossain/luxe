...
//           <a href="/SingUp" className="hover:underline underline-offset-8 decoration-1 transition-all">Sign Up</a>
//         </nav>
...
//               <a href="/SignUp" className="pb-1 hover:text-red-500" onClick={() => setIsMobileMenuOpen(false)}>Sign Up</a>
//             </nav>
//           </div>
//         </div>
//       )}
